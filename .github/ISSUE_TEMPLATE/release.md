...
- [ ] Merge the release using [Release Deployer](https://github.com/utexas-wcms/wcms-devops/actions/workflows/regular-release-deployer.yml). This will create a new tag and release.
- [ ] Confirm that the tag is correctly synced to the public mirror repository at https://github.com/utexas-wp/utexas-eid-auth/tags
